...
saveRDS(object = data,
        file = "tcga_data.RDS",
        compress = FALSE)
#This comment block was run first to get tcga_rds and was subsequently saved, so when running
#next time, you only need the saved file
...
colnames(clinical)[12]="figo_stage"
...
CBGs=read_excel("Supplementary table.xlsx", sheet = 4, skip = 1)
