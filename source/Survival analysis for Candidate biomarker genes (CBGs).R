...
#download tcga_data.RDS from https://drive.google.com/file/d/1nBizvqn6jEvjQQfcDlvRuE4NE6bvzB4H/view?usp=drive_link 
#and store it in Data folder and continue running the code

data <- readRDS("tcga_data.rds.gz")
